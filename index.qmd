...
Powered by [Data.org](https://data.org/), the [Epiverse-TRACE](https://data.org/initiatives/epiverse/) project has made substantial progress toward producing analytics tools aimed at addressing the most critical questions during epidemics. Currently, up to **eight (8)** [Epiverse-TRACE packages](https://epiverse-trace.github.io/etstats/articles/cran-statistics.html) are available on [CRAN](https://cran.r-project.org/), with about **twenty (20)** more under active development. This reflects the results of two years of joint efforts between team members and our user communities.
