...
day_1_agenda <- data.frame(
  ...
  Speakers = c("-", "Dr Bubacarr Bah, Pr Umberto D'Alessandro, Data.org (TBC), & MoH (TBC)", "", "Banky", "Data.org (TBC)", "", "James & Degoot", "")
)
...
day_2_agenda <- data.frame(
  ...
  Speakers = c("Groups Discussion", "Expert Presentation", "", "Groups Discussion", "", "James & Degoot", "")
)
day_2_agenda |>
  kableExtra::kbl() |>
...
-   Gibril Gabbidon and Alimatou Sallah

#### Column

![](./images/boat_ride.avif){fig-align="center" width="100%" hight="110%"}
...
day_5_agenda <- data.frame(
  ...
  Speakers = c(" Groups Discussion", "Groups Discussion", "", "Groups Discussion", "Groups Discussion", "", "", "")
)
...
day_4_agenda <- data.frame(
  ...
  Speakers = c("Groups Discussion", "", "Bubacarr Bah", "PI", "", "")
)
