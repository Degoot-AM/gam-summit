...
__Venue__: [Sir Dawda Kairaba Jawara International Conference Center](https://www.oicgambia.org/sdkj-icc), Serrekunda.
...
day_1_agenda <- data.frame(
  ...
  Speakers = c("-", "Dr Bubacarr Bah, Pro Umberto D'Alessandro, Data.org (TBC), & MoH (TBC)", "", "Banky", "Data.org (TBC)", "", "Degoot & James", "")
)
...
__Venue__: Bray conference room, MRCG
...
day_2_agenda <- data.frame(
  ...
  Activity = c("Lessons Learnt and Gaps", "Inclusivity and Sustainability of Epidemics Analytic Tools", "Coffee Break", "Inclusivity and Sustainability within Epiverse-TRACE Tools", "Lunch", "RF & RSE Sessions", "Dinner"),
  Speakers = c("Groups Discussion", "Expert Presentation", "", "Groups Discussion", "", "Degoot & James", "")
)
day_2_agenda |>
  kableExtra::kbl() |>
...
__Venue__: Bray conference room  & F1 Seminar room, MRCG 
...
day_4_agenda <- data.frame(
  ...
  Speakers = c("Groups Discussion", "", "Bubacarr Bah", "Presentation by one of our PIs", "", "")
)
