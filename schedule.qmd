...
**Openning ceremony and launch of phase 2 of Epiverse-TRACE**
...
day_2_agenda <- data.frame(
  ...
  Activity = c("Lessons learnt and gaps", "Inclisivity and sustainability of health care analytical tools", "Coffee break", "Inclusivity and sustainability within Epiverse-TRACE tools", "Lunch", "RF & RSE sessions", "Dinner"),
...
day_4_agenda <- data.frame(
  ...
  Activity = c("Designing outbreak analytics course", "Coffee break", "Closing Remarks", "Unite Seminar", "Lunch", " ", "Dinner"),
