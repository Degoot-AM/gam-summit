...
day_2_agenda |>
  ...
  kableExtra::row_spec(c(3, 6, 7), color = 'white', background = 'black')
```
...
These sessions will focus on how the Epiverse-TRACE analytics tools can be applied beyond the most “alarming” infectious diseases. Discussions will cover their usage in context of small-scale local outbreaks, neglected tropical diseases (NTDs), one health perspectives, and in disease surveillance.
...
On this last day, participants will focus on how to design a data-centered outbreak analytics course aimed at training and teaching outbreak analysis. It will also reflect on the lessons learnt from previous training and identify current gaps within the project and explore ways to overcome them.
...
day_4_agenda <- data.frame(
  Time = c("09:00-11:00", "11:00-11:30", "11:30-12:00", "12:00-13:00", "13:00-15:00", "15:00-17:00", "19:00-21:00"),
